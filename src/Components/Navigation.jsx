...
export default function Navigation() {
    return (
        <header className="sticky top-0 left-0 w-full  bg-white shadow-md  py-0.5 px-4 sm:px-6 flex items-center justify-between z-50 min-h-[10vh]">
            ...
            <div className="flex-shrink-0 flex items-center gap-2 sm:gap-3 md:gap-4">
                <img
                    ...
                    alt="Brgy Logo"
                    className="h-10 sm:h-12 md:h-14 object-cover rounded"
                />
                <img
                    src="/Images/BustosLogo.png"
                    alt="Bustos Logo"
                    className="h-11 sm:h-12 md:h-14 object-cover rounded"
                />
                <img
